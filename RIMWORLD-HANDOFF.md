...
|--------|--------|------------------|-------|
| A. AI plays RimWorld (RimBridge mod + MCP server for Claude) | `rimworld-ai-connector/` | `rimworld-ai-connector/HANDOFF.md` | built, tested, CI green; needs a live session with the game |
